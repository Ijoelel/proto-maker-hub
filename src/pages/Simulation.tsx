...
const ComponentSidebar = () => (
  <aside className="w-64 bg-[#3B5074] text-white flex flex-col">
    <ScrollArea className="flex-1">
      <div className="p-4">
        <h2 className="text-lg font-semibold flex items-center gap-2 mb-4"><Wrench size={20} /> Komponen</h2>
        <div className="grid grid-cols-2 gap-3">
          {components.map((comp, i) => (
            <div key={i} className="bg-[#2A3C5B] rounded-lg p-3 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-[#4a628a] transition-colors">
      ...
      <div className="p-4 space-y-3">
        <Button className="w-full bg-[#1E90FF] hover:bg-[#1C86EE] text-white justify-start"><Wand2 size={16} className="mr-2"/> Mode Kabel</Button>
        <Button className="w-full bg-[#DC143C] hover:bg-[#C71585] text-white justify-start"><RefreshCcw size={16} className="mr-2"/> Reset</Button>
        <Button className="w-full bg-[#FFD700] hover:bg-[#EEC900] text-black justify-start"><Book size={16} className="mr-2"/> Tutorial</Button>
      </div>
      <div className="p-4">
        <div className="bg-[#2A3C5B] rounded-lg p-3">
          <h3 className="text-sm font-semibold flex items-center gap-2 mb-2 text-yellow-400"><Info size={16} /> Petunjuk Penyambungan</h3>
...
const AnalysisSidebar = () => (
  <aside className="w-72 bg-[#3B5074] text-white p-4 flex flex-col space-y-4">
    <div className="space-y-4">
      <h2 className="text-lg font-semibold flex items-center gap-2"><Library size={20} /> Analisis Rangkaian</h2>
      <Badge variant="destructive" className="w-full justify-center text-base py-2"><XCircle size={16} className="mr-2"/> Rangkaian terbuka</Badge>
    ...
    <div className="space-y-4">
      <h2 className="text-lg font-semibold flex items-center gap-2"><Info size={20} /> Status Terminal</h2>
      <div className="space-y-3">
        <div className="bg-[#2A3C5B] rounded-lg p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
    ...
    <Separator className="bg-gray-500/50"/>
    <div className="space-y-4">
      <h2 className="text-lg font-semibold flex items-center gap-2"><Power size={20} /> Status Komponen</h2>
      <div className="space-y-3">
        <div className="bg-[#2A3C5B] rounded-lg p-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
