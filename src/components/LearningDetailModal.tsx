...
export function LearningDetailModal({ isOpen, onClose, title, content }: LearningDetailModalProps) {
  ...
  useEffect(() => {
    if (!isOpen) {
      // Reset state with a delay to allow closing animation
              ...
              {quizSubmitted && results ? (
                ...
                currentQuestion ? (
                  <div className="space-y-6">
                    ...
                    <div key={currentQuestionIndex} className="space-y-3 p-4 border rounded-lg bg-background">
                        ...
                        <div className="space-y-2 pt-2">
                            {currentQuestion.options.map((option, optionIndex) => (
                                ...
                                >
                                    <span className={`mr-2 font-bold ${selectedAnswers[currentQuestionIndex] === optionIndex ? 'text-primary' : 'text-muted-foreground'}`}>
                  ...
                  <div className="text-center py-10 text-muted-foreground">Tidak ada kuis untuk materi ini.</div>
                )
              )}
            </div>
          </TabsContent>
